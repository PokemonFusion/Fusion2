...
def load_modules():
	...
	ab_spec = importlib.util.spec_from_file_location("pokemon.dex.functions.abilities_funcs", ab_path)
	...
	it_spec = importlib.util.spec_from_file_location("pokemon.dex.functions.items_funcs", it_path)
