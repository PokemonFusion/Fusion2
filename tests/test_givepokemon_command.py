...
orig_enhanced = sys.modules.get("helpers.enhanced_evmenu")
...
if orig_enhanced is not None:
    sys.modules["helpers.enhanced_evmenu"] = orig_enhanced
else:
