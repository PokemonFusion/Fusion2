...
class CmdSpawns(Command):
	...
	def func(self):
		...
		def _menunode_get_rarity(caller, raw_input=None, **kwargs):
			if raw_input is None:
				return "Enter rarity (common/uncommon/rare/etc):", [{"key": "_default", "goto": ("get_rarity", kwargs)}]
		...
		def _menunode_get_tiers(caller, raw_input=None, **kwargs):
			if raw_input is None:
				return "Enter tiers separated by space:", [{"key": "_default", "goto": ("get_tiers", kwargs)}]
		...
		def _menunode_get_gens(caller, raw_input=None, **kwargs):
			if raw_input is None:
				return "Enter generations separated by space:", [{"key": "_default", "goto": ("get_gens", kwargs)}]
