...
class Raindance:
    ...
    def onFieldStart(self, field, source=None, *_, **__):
        field.pseudo_weather["raindance"] = {
            "duration": self.durationCallback(source=source)
        }
        return True
...
class Sandstorm:
    ...
    def onFieldStart(self, field, source=None, *_, **__):
        field.pseudo_weather["sandstorm"] = {
            "duration": self.durationCallback(source=source)
        }
        return True
...
class Snowscape:
    ...
    def onFieldStart(self, field, source=None, *_, **__):
        field.pseudo_weather["snowscape"] = {
            "duration": self.durationCallback(source=source)
        }
        return True
